...
public class Requester {
    ...
    private static final String requestQueue = "bookingRequest";
    private static final String responseQueue = "bookingResponse";
    // a record of all the requests we've sent
    // mapping from correlation Id to the payload record
    private static final Map<String, Map<String, String>> sentRequests = new HashMap<>();
    ...
    private static void usageExit(String message) {
        ...
        System.out.println("Argument 1: a number of messages to send, 0 for none, default 3");
    }
            ...
            public void onMessage(Message message) {
                try {
                    ...
                    if (originalRequest == null) {
                        System.out.printf("discarding unexpected response %s%n", correlationId);
                    } else {
